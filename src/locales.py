LOCALES = {
    'ru': {
        ...
        'out_of_stock_dl': "❌ Товар <b>{title}</b> нет в наличии\n\nВы можете добавить его в избранное, и вы получите уведомление, когда он снова появится.",
        'btn_add_favorite_track': "⭐ Добавить в избранное для отслеживания",
    ...
    'en': {
        ...
        'out_of_stock_dl': "❌ Product <b>{title}</b> is out of stock\n\nYou can add it to favorites and you will be notified when it's restocked.",
        'btn_add_favorite_track': "⭐ Add to favorites to track",
